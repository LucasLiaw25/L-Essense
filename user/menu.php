...
<nav class="flex items-center gap-4 py-6 mb-8 border-b border-stone-100 bg-white/50 backdrop-blur-sm sticky top-0 z-50">
    <div class="flex-1">
        ...
        <span class="font-serif text-2xl text-stone-900 leading-none">
    ...
    <div class="flex items-center gap-2">
        ...
        <?php if (isset($_SESSION['perfil']) && $_SESSION['perfil'] === 'admin'): ?>
            <a href="../dashboard/product.php" class="flex items-center gap-2 px-5 py-2.5 text-xs font-black uppercase tracking-widest bg-stone-900 text-stone-50 hover:bg-black rounded-2xl transition-all shadow-md shadow-stone-200">
                <i data-lucide="package" class="w-4 h-4"></i> Catálogo
            </a>
        <?php endif; ?>
...
<script>
    // Inicialização segura dos ícones Lucide no menu
